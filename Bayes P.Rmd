...
## Data
```{r}
Data <- read.csv(file = "https://raw.githubusercontent.com/Fran-Diaz-R/Bayes/main/data_full.csv")
...
dummy <- Data_43R %>% select(accuracy, session, Euclidean, CityBlock, a_n2)
colnames(dummy) <- c('y', 's', 'e', 'c', 'item')
```
